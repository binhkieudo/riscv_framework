...
module TLAtomicAutomata_1(
  ...
  wire [5:0]      _GEN_2 = {_GEN_1[5], _GEN_1[1:0], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14]};	// @[Parameters.scala:137:{31,45}]
  wire            a_isSupported = auto_in_a_bits_opcode == 3'h3 ? _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_2 == 6'h0) : auto_in_a_bits_opcode != 3'h2 | _a_canArithmetic_T_3 & (_GEN == 7'h0 | _GEN_0 == 7'h0 | _GEN_2 == 6'h0);	// @[AtomicAutomata.scala:92:47, :93:47, :94:{32,63}, Mux.scala:81:61, Parameters.scala:92:42, :137:{45,65}, :671:54, :672:42]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cam_a_0_bits_address = {_RANDOM_0[31:15], _RANDOM_1[13:0]};	// @[AtomicAutomata.scala:78:28, :79:24]
        cam_a_0_bits_mask = _RANDOM_1[21:14];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_bits_data = {_RANDOM_1[31:22], _RANDOM_2, _RANDOM_3[21:0]};	// @[AtomicAutomata.scala:79:24]
        cam_a_0_bits_corrupt = _RANDOM_3[22];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_fifoId = _RANDOM_3[23];	// @[AtomicAutomata.scala:79:24]
        cam_a_0_lut = _RANDOM_3[27:24];	// @[AtomicAutomata.scala:79:24]
        cam_d_0_data = {_RANDOM_3[31:28], _RANDOM_4, _RANDOM_5[27:0]};	// @[AtomicAutomata.scala:79:24, :80:24]
        cam_d_0_denied = _RANDOM_5[28];	// @[AtomicAutomata.scala:80:24]
        cam_d_0_corrupt = _RANDOM_5[29];	// @[AtomicAutomata.scala:80:24]
        beatsLeft = {_RANDOM_5[31:30], _RANDOM_6[6:0]};	// @[Arbiter.scala:88:30, AtomicAutomata.scala:80:24]
        state_0 = _RANDOM_6[7];	// @[Arbiter.scala:88:30, :117:26]
        state_1 = _RANDOM_6[8];	// @[Arbiter.scala:88:30, :117:26]
        d_first_counter = _RANDOM_6[17:9];	// @[Arbiter.scala:88:30, Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
