...
module ICache(
  ...
  wire [31:0]  _WIRE_2_1;	// @[ICache.scala:575:71]
  ...
  wire [31:0]  _WIRE_1_1;	// @[ICache.scala:575:71]
  ...
  wire [41:0]  _tag_array_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  ...
  wire         s1_hit = s1_tag_hit_0 | s1_tag_hit_1;	// @[ICache.scala:353:{35,40}, :506:26]
  ...
  assign tag_array_MPORT_mask_0 = ~_repl_way_v0_prng_io_out_0;	// @[ICache.scala:428:97, PRNG.scala:91:22]
  reg  [127:0] vb_array;	// @[ICache.scala:440:25]
  wire [127:0] _s1_vb_T_1 = vb_array >> io_s1_paddr[11:6];	// @[ICache.scala:440:25, :500:25, :850:21]
  ...
  wire [127:0] _s1_vb_T_5 = vb_array >> {122'h1, io_s1_paddr[11:6]};	// @[ICache.scala:440:25, :500:25, :850:21]
  ...
  assign _WIRE_1_1 = auto_master_out_d_bits_data[31:0];	// @[ICache.scala:575:71]
  assign data_arrays_0_MPORT_1_mask_0 = ~_repl_way_v0_prng_io_out_0;	// @[ICache.scala:578:102, PRNG.scala:91:22]
  ...
  assign _WIRE_2_1 = auto_master_out_d_bits_data[63:32];	// @[ICache.scala:575:71]
  assign data_arrays_1_MPORT_2_mask_0 = ~_repl_way_v0_prng_io_out_0;	// @[ICache.scala:578:102, PRNG.scala:91:22]
  ...
  wire [1:0]   _s2_tag_disparity_T = {s2_tag_disparity_r_1, s2_tag_disparity_r_0};	// @[ICache.scala:606:65, Reg.scala:19:16]
  ...
  wire [127:0] _vb_array_T_3 = 128'h1 << {121'h0, _repl_way_v0_prng_io_out_0, refill_paddr[11:6]};	// @[ICache.scala:444:32, :850:21, PRNG.scala:91:22, Reg.scala:19:16]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      vb_array <= 128'h0;	// @[ICache.scala:440:25]
    end
    else begin
    ...
    if (s1_valid) begin	// @[ICache.scala:333:25]
      ...
      s2_tl_error <= |{s1_tag_hit_1 & _tag_array_RW0_rdata[41], s1_tag_hit_0 & _tag_array_RW0_rdata[20]};	// @[DescribedSRAM.scala:17:26, ICache.scala:506:26, :510:32, :607:{43,50}, Reg.scala:19:16, package.scala:155:13]
    end
  ...
  `ifndef SYNTHESIS
    wire  [1:0]  _T_10 = {1'h0, s1_tag_hit_0} + {1'h0, s1_tag_hit_1};	// @[Bitwise.scala:51:90, ICache.scala:506:26]
    always @(posedge clock) begin	// @[ICache.scala:513:9]
      if (~reset & ~(~s1_valid | ~(_T_10[1]))) begin	// @[Bitwise.scala:51:90, ICache.scala:333:25, :513:{9,10,39,115}]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        vb_array = {_RANDOM_3[31:24], _RANDOM_4, _RANDOM_5, _RANDOM_6, _RANDOM_7[23:0]};	// @[Edges.scala:229:27, ICache.scala:440:25]
        s2_tag_hit_0 = _RANDOM_9[5];	// @[Reg.scala:19:16]
        s2_tag_hit_1 = _RANDOM_9[6];	// @[Reg.scala:19:16]
        s2_dout_0 = {_RANDOM_9[31:7], _RANDOM_10[6:0]};	// @[Reg.scala:19:16]
        s2_dout_1 = {_RANDOM_10[31:7], _RANDOM_11[6:0]};	// @[Reg.scala:19:16]
        s2_tag_disparity_r_0 = _RANDOM_11[7];	// @[Reg.scala:19:16]
        s2_tag_disparity_r_1 = _RANDOM_11[8];	// @[Reg.scala:19:16]
        s2_tl_error = _RANDOM_11[9];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  tag_array_0 tag_array (	// @[DescribedSRAM.scala:17:26]
    ...
    .RW0_wdata ({refillError, refill_paddr[31:12], refillError, refill_paddr[31:12]}),	// @[DescribedSRAM.scala:17:26, ICache.scala:380:33, :422:43, Reg.scala:19:16]
    .RW0_wmask ({_repl_way_v0_prng_io_out_0, tag_array_MPORT_mask_0}),	// @[DescribedSRAM.scala:17:26, ICache.scala:428:97, PRNG.scala:91:22]
  ...
  data_arrays_0_0 data_arrays_0 (	// @[DescribedSRAM.scala:17:26]
    ...
    .RW0_wdata ({2{_WIRE_1_1}}),	// @[DescribedSRAM.scala:17:26, ICache.scala:575:71]
    .RW0_wmask ({_repl_way_v0_prng_io_out_0, data_arrays_0_MPORT_1_mask_0}),	// @[DescribedSRAM.scala:17:26, ICache.scala:578:102, PRNG.scala:91:22]
  ...
  data_arrays_1 data_arrays_1 (	// @[DescribedSRAM.scala:17:26]
    ...
    .RW0_wdata ({2{_WIRE_2_1}}),	// @[DescribedSRAM.scala:17:26, ICache.scala:575:71]
    .RW0_wmask ({_repl_way_v0_prng_io_out_0, data_arrays_1_MPORT_2_mask_0}),	// @[DescribedSRAM.scala:17:26, ICache.scala:578:102, PRNG.scala:91:22]
  ...
  assign io_resp_bits_data = (s2_tag_hit_0 ? s2_dout_0 : 32'h0) | (s2_tag_hit_1 ? s2_dout_1 : 32'h0);	// @[Bundles.scala:259:74, Mux.scala:27:73, Reg.scala:19:16]
