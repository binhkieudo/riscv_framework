...
module Queue_61(
  ...
  wire [105:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[32:12];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[40:33];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[104:41];	// @[Decoupled.scala:273:95]
endmodule
