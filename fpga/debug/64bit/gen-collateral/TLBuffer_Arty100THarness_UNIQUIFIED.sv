...
module TLBuffer_Arty100THarness_UNIQUIFIED(
  input         clock,
                reset,
                auto_in_a_valid,
  ...
  Queue_Arty100THarness_UNIQUIFIED x1_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_1_Arty100THarness_UNIQUIFIED bundleIn_0_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
