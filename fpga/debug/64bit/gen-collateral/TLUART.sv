...
module TLUART(
  ...
  ila_0 ila_0(
    .clk    (clock                               ),
    .probe0 (auto_control_xing_in_a_valid        ),
    .probe1 (auto_control_xing_in_a_bits_address ),
    .probe2 (auto_control_xing_in_a_bits_mask    ),
    .probe3 (auto_control_xing_in_a_bits_data    )
  );
  ...
  Queue_75 txq (	// @[UART.scala:131:19]
    .clock        (clock),
    .reset        (reset),
  ...
  Queue_75 rxq (	// @[UART.scala:134:19]
    .clock        (clock),
    .reset        (reset),
