...
module AsyncQueueSink_2(
  ...
  wire [72:0]      _io_deq_bits_deq_bits_reg_io_q;	// @[SynchronizerReg.scala:207:25]
  ...
  wire [7:0][63:0] _GEN = {{io_async_mem_7_data}, {io_async_mem_6_data}, {io_async_mem_5_data}, {io_async_mem_4_data}, {io_async_mem_3_data}, {io_async_mem_2_data}, {io_async_mem_1_data}, {io_async_mem_0_data}};	// @[SynchronizerReg.scala:209:24]
  wire [7:0][7:0]  _GEN_0 = {{io_async_mem_7_strb}, {io_async_mem_6_strb}, {io_async_mem_5_strb}, {io_async_mem_4_strb}, {io_async_mem_3_strb}, {io_async_mem_2_strb}, {io_async_mem_1_strb}, {io_async_mem_0_strb}};	// @[SynchronizerReg.scala:209:24]
  wire [7:0]       _GEN_1 = {{io_async_mem_7_last}, {io_async_mem_6_last}, {io_async_mem_5_last}, {io_async_mem_4_last}, {io_async_mem_3_last}, {io_async_mem_2_last}, {io_async_mem_1_last}, {io_async_mem_0_last}};	// @[SynchronizerReg.scala:209:24]
  ...
  ClockCrossingReg_w73 io_deq_bits_deq_bits_reg (	// @[SynchronizerReg.scala:207:25]
    .clock (clock),
    .io_d  ({_GEN[index], _GEN_0[index], _GEN_1[index]}),	// @[AsyncQueue.scala:152:55, SynchronizerReg.scala:209:24]
  ...
  assign io_deq_bits_data = _io_deq_bits_deq_bits_reg_io_q[72:9];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_strb = _io_deq_bits_deq_bits_reg_io_q[8:1];	// @[SynchronizerReg.scala:207:25, :211:26]
