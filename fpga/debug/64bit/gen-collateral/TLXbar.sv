...
module TLXbar(
  ...
  wire        out_12_valid = idle ? _sink_ACancel_earlyValid_T : state_0 & auto_out_0_d_valid | state_1 & auto_out_1_d_valid;	// @[Arbiter.scala:89:28, :108:36, :117:26, :126:29, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[11:3]) : 9'h0) | {6'h0, winnerQual_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0};	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Edges.scala:106:36, :221:14, Xbar.scala:310:24, package.scala:235:{46,71,76}]
      else	// @[Arbiter.scala:90:24]
        beatsLeft <= beatsLeft - {8'h0, auto_in_d_ready & out_12_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, ReadyValidCancel.scala:49:33]
  ...
  assign auto_in_a_ready = ~(auto_in_a_bits_address[31]) & auto_out_0_a_ready | auto_in_a_bits_address[31] & auto_out_1_a_ready;	// @[Mux.scala:27:73, Parameters.scala:137:{45,65}]
  assign auto_in_b_valid = auto_out_1_b_valid;
  assign auto_in_b_bits_param = auto_out_1_b_bits_param;
  assign auto_in_b_bits_address = auto_out_1_b_bits_address;
  assign auto_in_c_ready = auto_out_1_c_ready;
  assign auto_in_d_valid = out_12_valid;	// @[Arbiter.scala:126:29]
  assign auto_in_d_bits_opcode = (muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73, Xbar.scala:310:24]
  assign auto_in_d_bits_param = (muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_param : 2'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_in_d_bits_size = (muxStateEarly_0 ? auto_out_0_d_bits_size : 4'h0) | (muxStateEarly_1 ? {1'h0, auto_out_1_d_bits_size} : 4'h0);	// @[Arbiter.scala:118:30, BundleMap.scala:247:19, Mux.scala:27:73, Xbar.scala:310:24]
  assign auto_in_d_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 2'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 2'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_in_d_bits_sink = (muxStateEarly_0 ? {1'h0, auto_out_0_d_bits_sink} : 2'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_sink : 2'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73, Xbar.scala:326:28]
  assign auto_in_d_bits_denied = muxStateEarly_0 & auto_out_0_d_bits_denied | muxStateEarly_1 & auto_out_1_d_bits_denied;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_in_d_bits_data = (muxStateEarly_0 ? auto_out_0_d_bits_data : 64'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_data : 64'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_in_d_bits_corrupt = muxStateEarly_0 & auto_out_0_d_bits_corrupt | muxStateEarly_1 & auto_out_1_d_bits_corrupt;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  assign auto_out_1_a_valid = auto_in_a_valid & auto_in_a_bits_address[31];	// @[Parameters.scala:137:45, Xbar.scala:431:50]
  ...
  assign auto_out_1_c_bits_size = auto_in_c_bits_size[2:0];	// @[BundleMap.scala:247:19]
  assign auto_out_1_c_bits_source = auto_in_c_bits_source;
  assign auto_out_1_c_bits_address = auto_in_c_bits_address;
  assign auto_out_1_c_bits_data = auto_in_c_bits_data;
  ...
  assign auto_out_1_e_valid = auto_in_e_valid;
  assign auto_out_1_e_bits_sink = auto_in_e_bits_sink;
  assign auto_out_0_a_valid = auto_in_a_valid & ~(auto_in_a_bits_address[31]);	// @[Parameters.scala:137:{45,65}, Xbar.scala:431:50]
  assign auto_out_0_a_bits_opcode = auto_in_a_bits_opcode;
  assign auto_out_0_a_bits_param = auto_in_a_bits_param;
  assign auto_out_0_a_bits_size = auto_in_a_bits_size;
  assign auto_out_0_a_bits_source = auto_in_a_bits_source;
  assign auto_out_0_a_bits_address = auto_in_a_bits_address[30:0];	// @[BundleMap.scala:247:19]
