...
vlog -work xpm -64 -incr -mfcu  -sv "+incdir+../../../../Arty100THarness.gen/sources_1/ip/ila_0/hdl/verilog" \
...
vlog -work xil_defaultlib -64 -incr -mfcu  "+incdir+../../../../Arty100THarness.gen/sources_1/ip/ila_0/hdl/verilog" \
