...
module ResetCatchAndSync_d3_Arty100THarness_UNIQUIFIED(
  input  clock,
         reset,
  ...
  AsyncResetSynchronizerShiftReg_w1_d3_i0_Arty100THarness_UNIQUIFIED io_sync_reset_chain (	// @[ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
