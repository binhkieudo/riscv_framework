...
module TLToAXI4(
  ...
  wire [15:0]      _GEN_0 = {{count_16}, {count_15}, {count_14}, {count_13}, {count_12}, {count_11}, {count_10}, {count_9}, {count_8}, {count_7}, {count_6}, {count_5}, {count_4}, {count_3}, {count_2}, {count_1}};	// @[ToAXI4.scala:198:49, :257:28]
  ...
  wire             inc_2 = out_arw_bits_id == 4'h2 & _inc_T_15;	// @[Decoupled.scala:51:35, OneHot.scala:64:12, ToAXI4.scala:169:17, :245:58, :261:22]
  wire             dec_2 = d_sel_shiftAmount == 4'h2 & d_last & _dec_T_31;	// @[Decoupled.scala:51:35, OneHot.scala:64:12, ToAXI4.scala:246:{31,93}, :247:23, :262:32]
  ...
  assign auto_in_d_bits_opcode = {2'h0, r_wins};	// @[Edges.scala:232:25, ToAXI4.scala:218:53, :240:23]
