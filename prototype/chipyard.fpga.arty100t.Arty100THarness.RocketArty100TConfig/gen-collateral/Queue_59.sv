...
module Queue_59(
  ...
  wire [99:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[26:13];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[34:27];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[98:35];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[99];	// @[Decoupled.scala:273:95]
endmodule
