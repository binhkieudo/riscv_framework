...
module TilePRCIDomain(
  ...
  wire [1:0]  _buffer_auto_in_d_bits_sink;	// @[Buffer.scala:69:28]
  ...
  wire [1:0]  _tile_reset_domain_tile_auto_buffer_out_e_bits_sink;	// @[HasTiles.scala:251:53]
  ...
  TLBuffer_12 buffer (	// @[Buffer.scala:69:28]
    .clock                   (auto_tap_clock_in_clock),
    .reset                   (auto_tap_clock_in_reset),
