...
module IBuf(
  ...
  always @(posedge clock) begin
    ...
    if (io_inst_0_ready & _T_7) begin	// @[IBuf.scala:35:16, :47:29, :54:{68,94}, :57:13]
      buf_pc <= io_imem_bits_pc & 34'h3FFFFFFFC | io_imem_bits_pc + {31'h0, nICReady, 1'h0} & 34'h3;	// @[IBuf.scala:34:47, :35:16, :42:25, :59:{35,37,49,68,109}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        buf_pc = {_RANDOM_1[31:18], _RANDOM_2[19:0]};	// @[IBuf.scala:35:16]
        buf_data = {_RANDOM_2[31:20], _RANDOM_3[19:0]};	// @[IBuf.scala:35:16]
        buf_xcpt_pf_inst = _RANDOM_3[22];	// @[IBuf.scala:35:16]
        buf_xcpt_gf_inst = _RANDOM_3[23];	// @[IBuf.scala:35:16]
        buf_xcpt_ae_inst = _RANDOM_3[24];	// @[IBuf.scala:35:16]
        buf_replay = _RANDOM_3[25];	// @[IBuf.scala:35:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
