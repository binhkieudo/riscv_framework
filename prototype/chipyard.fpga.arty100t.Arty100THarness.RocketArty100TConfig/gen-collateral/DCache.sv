...
module DCache(
  ...
  wire [2:0]       _GEN_13 = {s1_tlb_req_vaddr[31], s1_tlb_req_vaddr[20], s1_tlb_req_vaddr[16]};	// @[Parameters.scala:137:45, Reg.scala:19:16]
  wire [2:0]       _GEN_14 = {s1_tlb_req_vaddr[31], s1_tlb_req_vaddr[26], ~(s1_tlb_req_vaddr[20])};	// @[Parameters.scala:137:{31,45}, Reg.scala:19:16]
  wire [1:0]       _GEN_15 = s1_tlb_req_vaddr[26:25] ^ 2'h2;	// @[Parameters.scala:137:31, Reg.scala:19:16, TLB.scala:465:40]
  wire [1:0]       _GEN_16 = {s1_tlb_req_vaddr[31], _GEN_15[1]};	// @[Parameters.scala:137:{31,45}, Reg.scala:19:16]
  wire             tlb_prot_pp = tlb_legal_address & (_GEN_13 == 3'h0 | _GEN_14 == 3'h0 | _GEN_16 == 2'h0 | s1_tlb_req_vaddr[31]);	// @[Parameters.scala:137:{45,65}, :616:89, Reg.scala:19:16, Replacement.scala:168:70, TLB.scala:410:67, :413:19]
  wire             tlb_prot_al = tlb_legal_address & (_GEN_13 == 3'h0 | _GEN_14 == 3'h0 | _GEN_16 == 2'h0);	// @[Parameters.scala:137:{45,65}, :616:89, Replacement.scala:168:70, TLB.scala:410:67, :413:19]
  wire             tlb_prot_aa = tlb_legal_address & (_GEN_13 == 3'h0 | _GEN_14 == 3'h0 | _GEN_16 == 2'h0);	// @[Parameters.scala:137:{45,65}, :616:89, Replacement.scala:168:70, TLB.scala:410:67, :413:19]
  wire [3:0]       _GEN_17 = s1_tlb_req_vaddr[3:0] & (4'h1 << s1_tlb_req_size) - 4'h1;	// @[OneHot.scala:57:35, Reg.scala:19:16, TLB.scala:539:{39,69}, package.scala:16:47]
  ...
  wire             _GEN_19 = _io_cpu_perf_acquire_T & s2_uncached;	// @[DCache.scala:213:33, :401:39, :608:26, :609:24, :611:18, :612:13, Decoupled.scala:51:35]
  wire             _GEN_20 = _T_307 & _T_323 & c_first;	// @[DCache.scala:651:26, :840:102, :856:41, :857:26, Decoupled.scala:51:35, Edges.scala:231:25, package.scala:73:59]
  always @(posedge clock) begin
    if (reset) begin
      ...
      release_ack_wait <= _GEN_20 | (~_io_errors_bus_valid_T | grantIsCached | grantIsUncached | ~grantIsVoluntary) & release_ack_wait;	// @[DCache.scala:203:33, :608:26, :642:32, :651:26, :652:26, :684:36, :686:24, :840:102, :856:41, :857:26, Decoupled.scala:51:35, package.scala:73:59]
      ...
      uncachedInFlight_0 <= (~_io_errors_bus_valid_T | grantIsCached | ~(grantIsUncached & _T_271)) & (_GEN_19 | uncachedInFlight_0);	// @[DCache.scala:213:33, :608:26, :609:24, :611:18, :612:13, :651:26, :652:26, :661:35, :663:{17,28}, :665:13, Decoupled.scala:51:35, package.scala:73:59]
    ...
    if (_GEN_20)	// @[DCache.scala:651:26, :840:102, :856:41, :857:26]
      release_ack_addr <= probe_bits_address;	// @[DCache.scala:204:29, Reg.scala:19:16]
    if (_GEN_19) begin	// @[DCache.scala:213:33, :608:26, :609:24, :611:18, :612:13]
    ...
    if (s1_valid_not_nacked) begin	// @[DCache.scala:164:38]
      ...
      s2_tlb_xcpt_ae_ld <= tlb_cmd_read & (_GEN_18 | ~(tlb_legal_address & ~tlb_deny_access_to_debug & _tlb_pmp_io_r));	// @[Consts.scala:85:68, DCache.scala:319:24, TLB.scala:403:19, :410:67, :418:50, :419:{44,66}, :571:37, :575:{24,44,46}]
      s2_tlb_xcpt_ae_st <= (tlb_cmd_write | s1_tlb_req_cmd == 5'h5 | s1_tlb_req_cmd == 5'h17) & (_GEN_18 | ~(tlb_legal_address & (_GEN_13 == 3'h0 | _GEN_14 == 3'h0 | _GEN_16 == 2'h0 | s1_tlb_req_vaddr[31]) & ~tlb_deny_access_to_debug & _tlb_pmp_io_w)) | tlb_cmd_put_partial & ~(tlb_prot_pp | tlb__cacheable_T_13) | tlb__cmd_amo_logical_T_6 & ~(tlb_prot_al | tlb__cacheable_T_13) | tlb__cmd_amo_arithmetic_T_8 & ~(tlb_prot_aa | tlb__cacheable_T_13);	// @[Consts.scala:86:76, DCache.scala:319:24, Parameters.scala:137:{45,65}, :616:89, Reg.scala:19:16, Replacement.scala:168:70, TLB.scala:403:19, :410:67, :413:19, :418:50, :419:44, :420:70, :533:39, :534:39, :535:39, :562:41, :566:35, :571:37, :577:{8,35,37}, :578:{8,26}, :579:{8,26,53}, :580:{8,29}, package.scala:16:47, :73:59]
      s2_tlb_xcpt_ma_ld <= (|_GEN_17) & tlb_cmd_read;	// @[Consts.scala:85:68, DCache.scala:319:24, TLB.scala:539:{39,77}, :634:31]
      s2_tlb_xcpt_ma_st <= (|_GEN_17) & tlb_cmd_write;	// @[Consts.scala:86:76, DCache.scala:319:24, TLB.scala:539:{39,77}, :635:31]
  ...
  `ifndef SYNTHESIS
    wire         _GEN_21 = _io_errors_bus_valid_T & ~grantIsCached;	// @[DCache.scala:652:26, Decoupled.scala:51:35, package.scala:73:59]
    always @(posedge clock) begin	// @[DCache.scala:1162:11]
      ...
      if (_GEN_21 & grantIsUncached & _T_271 & ~reset & ~uncachedInFlight_0) begin	// @[DCache.scala:213:33, :652:26, :663:17, :664:17, package.scala:73:59]
      ...
      if (_GEN_21 & ~grantIsUncached & grantIsVoluntary & ~reset & ~release_ack_wait) begin	// @[DCache.scala:203:33, :642:32, :652:26, :661:35, :685:13, package.scala:73:59]
