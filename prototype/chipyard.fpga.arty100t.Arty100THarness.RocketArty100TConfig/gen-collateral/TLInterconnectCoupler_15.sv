...
module TLInterconnectCoupler_15(
  ...
  wire [2:0]  _fragmenter_auto_in_d_bits_source;	// @[Fragmenter.scala:335:34]
  ...
  wire [6:0]  _fragmenter_auto_out_a_bits_source;	// @[Fragmenter.scala:335:34]
  ...
  wire [6:0]  _fixer_auto_in_d_bits_source;	// @[FIFOFixer.scala:146:27]
  ...
  TLFragmenter_8 fragmenter (	// @[Fragmenter.scala:335:34]
    .clock                   (clock),
    .reset                   (reset),
