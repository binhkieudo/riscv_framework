...
set_property -dict [list \
 ...
 CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {166.666} \
...
set freq [expr { 100.0 * $mult / $div1 / $div2 }]
if {$freq < 164.99934 || $freq > 168.33266} {
  puts "Achieved frequency $freq MHz is outside tolerated range 164.99934-168.33266"
  exit 1
}
puts "Achieve frequency $freq MHz phase $phase degrees jitter $jitter ps"
