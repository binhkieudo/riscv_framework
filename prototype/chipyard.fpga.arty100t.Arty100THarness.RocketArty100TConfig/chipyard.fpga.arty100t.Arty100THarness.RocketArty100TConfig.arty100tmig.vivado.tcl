set migprj {<?xml version='1.0' encoding='UTF-8'?>
   ...
   set migprjfile {/arty100tmig.prj}
   set migprjfilepath $ipdir$migprjfile
   set fp [open $migprjfilepath w+]
   puts $fp $migprj
   close $fp
   create_ip -vendor xilinx.com -library ip -name mig_7series -module_name arty100tmig -dir $ipdir -force
   set_property CONFIG.XML_INPUT_FILE $migprjfilepath [get_ips arty100tmig] 