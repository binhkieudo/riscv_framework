...
// Memory map
#define CORE0_PRIVATE_MEM _AC(0x40000000, UL)
#define CORE1_PRIVATE_MEM _AC(0x40001000, UL)
#define CORE2_PRIVATE_MEM _AC(0x40002000, UL)
...
#define C0_MUTEX_KEY    (BRAM_MEM_ADDR + 0x1fd0)
#define C1_MUTEX_KEY    (BRAM_MEM_ADDR + 0x1fd4)
#define C2_MUTEX_KEY    (BRAM_MEM_ADDR + 0x1fd8)
#define C3_MUTEX_KEY    (BRAM_MEM_ADDR + 0x1fdc)
...
// Misc
#define LOCK_KEY  (MEMORY_MEM_ADDR + 0xFFFC8)
